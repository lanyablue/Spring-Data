...
public class RelatoriosService {
        ...
        while(system) {
            ...
            switch (action) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    pesquisaFuncionarioSalario(scanner);
                    break;
                default:
                    system = false;
                    break;
    ...
    private void buscaFuncionarioNomeSalarioMaiorData (Scanner scanner) {
        ...
        LocalDate localDate = LocalDate.parse(data, formatter); //formatação da data
    ...
    private void pesquisaFuncionarioSalario(Scanner scanner) {
